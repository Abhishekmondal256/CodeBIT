    ...
    return (
        <div className="flex items-center justify-between text-[15px] py-4 border border-[#293139] bg-[#21272e] rounded-lg h-[250px] px-4">
            ...
            <div className="flex flex-col justify-center">
                ...
                <div className={`${compName}-regDates`}>
                    <strong>Registration:</strong> {registrationTimeline?.start ? new Date(registrationTimeline.start).toLocaleDateString() : 'N/A'} to {registrationEnd ? registrationEnd.toLocaleDateString() : 'N/A'}
                </div>
                <div className={`${compName}-hackathonDates`}>
                    <strong>{compName === "hackathon" ? "Hackathon" : "Contest"}:</strong> {hackathonTimeline?.start ? new Date(hackathonTimeline.start).toLocaleDateString() : 'N/A'} to {hackathonEnd ? hackathonEnd.toLocaleDateString() : 'N/A'}
                </div>
            </div>
